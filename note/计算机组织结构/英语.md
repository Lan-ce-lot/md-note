...
| AC    | Accumulator                                        | 通常简称为[累加器](https://baike.baidu.com/item/累加器/8590163)，它是一个[通用寄存器](https://baike.baidu.com/item/通用寄存器/283978)。其功能是：当[运算器](https://baike.baidu.com/item/运算器/2667320)的算术逻辑单元(ALU)执行算术或[逻辑运算](https://baike.baidu.com/item/逻辑运算/7224729)时，为ALU提供一个工作区。累加寄存器暂时存放ALU运算的结果信息。显然，运算器中至少要有一个累加寄存器。在运算器中，累加器是专门存放算术或逻辑运算的一个[操作数](https://baike.baidu.com/item/操作数/7658270)和运算结果的[寄存器](https://baike.baidu.com/item/寄存器/187682)。能进行加、减、读出、[移位](https://baike.baidu.com/item/移位/4491197)、[循环移位](https://baike.baidu.com/item/循环移位/12723347)和求补等操作。是运算器的主要部分。 |
